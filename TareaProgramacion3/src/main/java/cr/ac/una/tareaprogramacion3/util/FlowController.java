...
import cr.ac.una.tareaprogramacion3.App;
...
public class FlowController {
    ...
    private FXMLLoader getLoader(String name) {
        ...
        if (loader == null) {
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        loader = new FXMLLoader(App.class.getResource("/cr/ac/una/tareaprogramacion3/views/" + name + ".fxml"), this.idioma);
    ...
    public void goMain() {
        try {
            mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("/cr/ac/una/tareaprogramacion3/views/PrincipalView.fxml"), idioma)));
            mainStage.show();
    ...
    public void goViewInWindow(String viewName) {
        ...
        stage.setTitle("Proyecto Programación II");
